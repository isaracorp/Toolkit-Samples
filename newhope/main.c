/** @file main.c
 *
 * @brief Demonstrate the toolkit's NewHope implementation.
 *
...
// ---------------------------------------------------------------------------------------------------------------------------------
// This function showcases the use of the NewHope algorithm to generate a
// shared secret.
//
...
static iqr_retval showcase_newhope(const iqr_Context *ctx, const iqr_RNG *rng, bool dump, const iqr_NewHopeVariant *variant)
{
     ...
     * the NewHope data protocol works see the README.md.
     */
...
int main(int argc, const char **argv)
{
    ...
    iqr_RNG *rng = NULL;
    bool dump = false;
    const iqr_NewHopeVariant *variant = &IQR_NEWHOPE_REFERENCE;
    ...
    /* This function showcases the usage of NewHope. */
    ret = showcase_newhope(ctx, rng, dump, variant);
