 ...
 * understand the data flow of ECDH. Again, don't read this file! You're
...
#define MAX_PAYLOAD_BYTES   133  // The largest key size used in ECDH is 133 bytes.

/* Alice sends alice public key and is stored in index 0.
 * Bob sends bob public key and is stored in index 1.
 */
...
/* Bob sends bob public key to alice */
